...
class TCPDF {
	 ...
	 * @public
	 */
	public function setHeaderData($ln='', $lw=0, $ht='', $hs='',$hs2='', $tc=array(0,0,0), $lc=array(0,0,0)) {
		$this->header_logo = $ln;
		$this->header_logo_width = $lw;
		$this->header_title = $ht;
		$this->header_string = $hs;
                $this->header_string2 = $hs2;//personalizado!!!!!!
	 ...
	 * @public
	 */
	public function setFooterData($tc=array(0,0,0), $lc=array(0,0,0),$fs) {
		$this->footer_text_color = $tc;
		$this->footer_line_color = $lc;
                $this->footer_string= $fs;//personalizado!!!!!!
	}
	...
	public function getHeaderData() {
		...
		$ret['string'] = $this->header_string;
                $ret['string2'] = $this->header_string2;//personalizado
	...
	public function Header() {
		if ($this->header_xobjid < 0) {
			...
			$this->SetX($header_x);
                        $this->MultiCell($cw, $cell_height, $headerdata['string2'], 0, 'C', 0, 1, '', '', true, 0, false, true, 0, 'T', false);
			//PERSONALIZADO!!!!!!!
